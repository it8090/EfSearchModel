...
namespace EfSearchModel.Tests {
    ...
    public class QueryableExtensionsTest {
        ...
        public void EqualInputIsUnixDateTime() {
            var item = new ConditionItem { Field = "AddTime", Method = QueryMethod.Equal, Value = "2016-09-01" };
            IQueryable<MyClass> query = _table.AsQueryable();
        ...
        public void EqualInputIsDateTime() {
            var item = new ConditionItem { Field = "Time", Method = QueryMethod.Equal, Value = "2016-09-01" };
            IQueryable<MyClass> query = _table.AsQueryable();
        ...
        public void DateBlockUnixDateTime() {
            var item = new ConditionItem { Field = "AddTime", Method = QueryMethod.DateBlock, Value = "2016-09-04" };
            IQueryable<MyClass> query = _table.AsQueryable();
            IQueryable<MyClass> actual = query.Where(GetModel(item));
            Assert.AreEqual(1, actual.Count());
        }
        ...
        public void DateBlockDateTime() {
            var item = new ConditionItem { Field = "Time", Method = QueryMethod.DateBlock, Value = "2016-09-04" };
            IQueryable<MyClass> query = _table.AsQueryable();
            IQueryable<MyClass> actual = query.Where(GetModel(item));
            Assert.AreEqual(1, actual.Count());
        }
        ...
        public void DateBetweenUnixTime() {
            var item = new ConditionItem { Field = "AddTime", Method = QueryMethod.LessThan, Value = "2016-09-04" };
            var item2 = new ConditionItem { Field = "AddTime", Method = QueryMethod.GreaterThan, Value = "2016-09-04" };
            IQueryable<MyClass> query = _table.AsQueryable();
        ...
        public void DateBetweenDateTime() {
            var item = new ConditionItem { Field = "Time", Method = QueryMethod.LessThan, Value = "2016-09-04" };
            var item2 = new ConditionItem { Field = "Time", Method = QueryMethod.GreaterThan, Value = "2016-09-04" };
            IQueryable<MyClass> query = _table.AsQueryable();
