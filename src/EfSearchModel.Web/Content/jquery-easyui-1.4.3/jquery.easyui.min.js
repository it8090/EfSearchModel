...
if(type=="checked"){
//return (_7ca==1?dc.body1:dc.body2).find(">table>tbody>tr.datagrid-row-checked"); XW优化
return (_7ca==1?dc.body1:dc.body2).find(">table>tbody>tr.datagrid-row>td>div.datagrid-cell-check>input:checked").parent().parent().parent();
}else{
if(type=="editing"){
